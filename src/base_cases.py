...
def sim_lane_changing(scheduler, time_of_sim, change_lane=False, overtake = False):
...
# ========================= Base cases ============================
results, results_dict1 = sim_lane_changing(scheduler,sim_time,change_lane=False)
scheduler.reset()
results, results_dict2 = sim_lane_changing(scheduler,sim_time,change_lane=True)
scheduler.safe_results_to_file("test")
scheduler.reset()
results, results_dict3 = sim_lane_changing(scheduler,sim_time,change_lane=True,overtake=True)
scheduler.reset()
